      ...
      fetch("/getImagesClient/".concat(id), {
        ...
        if (thisRes) {
          for (var i = 0; i < Object.keys(thisRes).length; i++) {
            ...
            if (thisRes[i].secondaire) setSecond(thisRes[i]); // if(images[i].visible)
            // 	setDisplay(...images[i])
